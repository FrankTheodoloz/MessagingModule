...
<div class="container">
    ...
    <div class="row mt-4">
        ...
        <div class="col-md-6 mb-4">
            <div class="card">
                <div class="card-header"><h2><i class="fas fa-wrench text-primary" aria-hidden="true"></i> Settings</h2></div>
                <div class="card-body">
                    <div class="card-text">Change Website and application-related Settings<br/>&nbsp;</div>
                </div>
                <div class="card-footer text-right">
        ...
        <div class="col-md-6">
            <div class="card mb-4">
                <div class="card-header"><h2><i class="fas fa-toolbox text-primary" aria-hidden="true"></i> Maintenance</h2></div>
                <div class="card-body">
                    <div class="card-text">Maintenance for Subject, Messages & Notifications<br/><br/></div>
                </div>
                <div class="card-footer text-right">
                    <a type="button" class="btn btn-primary" href="?id=<?= fctUrlOpensslCipher("maintenance.php") ?>"><i class="far fa-arrow-alt-circle-right"></i> Manage Database</a>
                </div>
            </div>
        </div>
    ...
    <div class="col mt-4">
        <a class="btn text-muted" href="?id=<?= fctUrlOpensslCipher("index.php") ?>">
            <h4>back to homepage <i class="fas fa-angle-double-left " aria-hidden="true"></i></h4>
        </a>
    </div>
</div>
